...
from .editing import ProjectionEditCandidate, build_projection_edit_candidate, commit_projection_edit, interpret_structured_text_edit
...
from .sos import SemanticSlot, CompositionSlot, ProjectionSlot, OperatorDescriptor, OperatorRegistry, CompositionStatus, CompositionContext, RVPCheck, CompositionReport, OperatorClosure, BrokenOperator, descriptor_record, descriptor_hash, basic_operator_registry, validate_composition, closure_hash, compose, compose_chain
from .sos_lowering import lower_closure_to_project
from .paradigm import BaseSpace, FillMode, ObservationMode, ParadigmTag, PARADIGMS, PlannerProfile, RegionEvidence, StrategyRegion, ParadigmClassification, paradigm_by_code, paradigm_by_index, paradigm_for, extract_strategy_regions, classify_region
from .paradigm_planner import CostBreakdown, ExecutionStrategyCandidate, BondViolation, BondObligation, BondDecision, ExecutionStrategyPlan, candidate_strategies, rank_candidates, validate_bonds, plan_graph, plan_hash
...
__all__ = [
    ...
    "FieldChange", "NodeDelta", "EdgeDelta", "GraphDiff", "diff_graphs", "ProjectionEditCandidate", "build_projection_edit_candidate", "interpret_structured_text_edit", "commit_projection_edit", "project_audit_view", "project_error_view", "diff_project_graphs", "preview_structured_edit",
    ...
    "ExecutionEnvironment", "ExecutionResult", "ExecutionTrace", "TraceRecord", "validate_runtime_value", "Interpreter", "NumPyBackend", "ProjectionSnapshot", "project_text", "project_formula", "project_graph_view", "project_editable_text", "parse_editable_text", "project_snapshot", "load_project", "load_ai_build_request", "preview_project_ai_build", "audit_project_ai_build", "commit_project_ai_build", "run_graph", "run_project", "find_graph", "GradientExecutionResult", "differentiate_project", "run_gradient", "run_project_gradient", "train_project", "interop_to_numpy", "interop_to_dlpack", "interop_from_dlpack", "preview_node_graph_edit_project", "preview_formula_edit_project", "run_project_notebook", "plan_project_memory", "verify_project_memory_plan", "select_project_memory_plan", "plan_project_paradigms",
    "ErrorDetail", "NovaError", "ValidationError", "ShapeError", "ConflictError", "PatchError", "DecodeError", "MigrationError", "DiffError",
    "ExecutionError", "MissingInputError", "RuntimeShapeError", "UnsupportedOperationError", "DependencyError", "BackendError", "ResourcePlanningError", "ResourceVerificationError", "AIBuildError", "AISandboxError", "AIBuildConflictError", "OperatorDescriptorError", "CompositionError", "CompCollapseError", "GIncoherenceError", "SemDivergenceError", "EffectCompositionError", "CompositionDepthError", "BrokenOperatorPropagationError", "ProjectionError", "ProjectionEditError", "FormulaEditError", "NotebookError", "TrainingError", "InteropError", "DTypeInteropError", "DLPackInteropError",
    ...
    "CostBreakdown", "ExecutionStrategyCandidate", "BondViolation", "BondObligation", "BondDecision", "ExecutionStrategyPlan", "candidate_strategies", "rank_candidates", "validate_bonds", "plan_graph", "plan_hash",
    "BaseSpace", "FillMode", "ObservationMode", "ParadigmTag", "PARADIGMS", "PlannerProfile", "RegionEvidence", "StrategyRegion", "ParadigmClassification", "paradigm_by_code", "paradigm_by_index", "paradigm_for", "extract_strategy_regions", "classify_region",
    "SemanticSlot", "CompositionSlot", "ProjectionSlot", "OperatorDescriptor", "OperatorRegistry", "CompositionStatus", "CompositionContext", "RVPCheck", "CompositionReport", "OperatorClosure", "BrokenOperator", "descriptor_record", "descriptor_hash", "basic_operator_registry", "validate_composition", "closure_hash", "compose", "compose_chain", "lower_closure_to_project", "list_operator_descriptors", "compose_operator_ids", "validate_operator_ids", "lower_operator_ids",
